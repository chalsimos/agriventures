                ...
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar">
                        ...
                        <div class="sidebar__item">
                            <h4>Provinces</h4>
                            <ul>
                                <li v-for="municipality in cities">  <router-link :to="`/municipality/${encodeId(municipality.municipality)}`">{{municipality.municipality}}</router-link></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div v-for="prod in products" class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" >
                                    <img :src="getFullImageUrl(prod.p_image)" alt="">
